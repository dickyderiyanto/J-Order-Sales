...
class Penjualan extends CI_Controller {
	...
	public function index()
	{
		...
		$where="TGLFAKTUR<='".$BegDate->BegDate."' AND TGLFAKTUR<='".$BegDate->BegDate."'";

		$data['penjualan'] = $this->M_Master->get_penjualan($where)->result();

		$this->load->view('v_header',$data);
		$this->load->view('J-Order/v_menu');
		$this->load->view('J-Order/v_penjualan',$data);
