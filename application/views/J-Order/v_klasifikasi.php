...
<script type="text/javascript">
	...
	$(document).ready(function() {
    	...
    	var nama_supplier = "-";
    	$.ajax({
    		url: '<?php echo base_url(); ?>J-Order/SalesPlanWeekly/ajax_principle',
    		type: "GET",
    		dataType: "json",
    	...
    	$('#btnShow').click(function(){
    		...
    		$.getJSON(rootPath + 'J-Order/SalesPlanWeekly/ajax_klasifikasi', {kode_supplier : KodeSupplier}, function (data) {
    			$('#bodyKlasifikasi tr').remove();
    	...
    	$('#btnSave').click(function(){
    		if(isShowed){
    			...
    			$(".ProdukGrup").each(function() {
    				...
    				$.post(rootPath +"J-Order/SalesPlanWeekly/add_klasifikasi", {
