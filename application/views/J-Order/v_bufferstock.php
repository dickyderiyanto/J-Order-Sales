		...
		<div class="col-md-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form role="form" method="post" action="<?php echo base_url('J-Order/Stok/update_stok_supplier'); ?>">
						<!-- <div class="panel-heading"> -->
						...
						<div class="canvas-wrapper">
							<!-- <form role="form" method="post" action="<?php echo base_url('J-Order/Stok/update_stok_supplier'); ?>"> -->
								<div class="form-group col-sm-3">
									<select class="js-example-basic-single" size="400px" name="supplier" class="form-control">
										<option value="0">--- Set to All Supplier ---</option>
									</select>
								</div>

								<div class="input-group col-sm-offset-5 col-sm-3">
									<input type="number" name="iron_stok_supplier" value="0" style="margin-right: 10px;"><div class="input-group-addon" >days</div>
									<button type="submit" class="btn btn-info" style="margin-left: 10px;" >Set Iron Stock</button>
								</div>
							<!-- </form> -->
						</div>
						<!-- <div class="panel-heading"> -->
						...
						<div class="canvas-wrapper">
							<div  style="margin-left: 15px;" class="form-group"> 
								<select class="s_produk" width="400px" name="produk"  class="form-control">
	...
	<script type="text/javascript">
		$(document).ready( function () {
			 ...
			 $('.js-example-basic-single').on('change', function() {
		      var kodesup1 = $(".js-example-basic-single option:selected").val();
			      $('.s_group').select2({
						...
						width: '400px',
				        ajax: {
				        	url: "<?php echo base_url(); ?>J-Order/Stok/get_bs_group/"+kodesup1,
				          	dataType: 'json',
				          	delay: 250,
					...
					$('#tabled_barang').DataTable().ajax.url('<?php echo base_url(); ?>J-Order/Stok/get_bs_produk/'+kodeProduk+'/'+kodeGroup+'/'+kodesup1).load();
			...
			$('.s_group').on('change', function() {
		      ...
		      var kodesup1 = $(".js-example-basic-single option:selected").val();
		      		...
		      		$('.s_produk').select2({
						...
						width: '400px',
				        ajax: {
				        	url: "<?php echo base_url(); ?>J-Order/Stok/get_produk/"+kodeGroup,
				          	dataType: 'json',
				          	delay: 250,
				          	processResults: function (data) {
					            return {
			...
			$('.js-example-basic-single').select2({
				...
				width: '400px',
		        ajax: {
		        	url: "<?php echo base_url(); ?>J-Order/Stok/get_bs_supplier/"+kodesup,
		          	dataType: 'json',
		          	delay: 250,
		          	processResults: function (data) {
			            return {
			...
			$('#tabled_barang').DataTable({
            	...
            	Destroy: true,
    			 "ajax": {
		            "url": "<?php echo base_url(); ?>J-Order/Stok/get_bs_produk/"+kodeProduk+"/"+kodeGroup+"/"+kodesup1,
		            "dataSrc": ""
		        },
		        "columns": [
		            { "data": "NamaSupplier" },
