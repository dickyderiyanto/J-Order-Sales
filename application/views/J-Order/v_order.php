							...
							<div id="tabel_order2">
						        ...
						        <tfoot>
	            					...
	            					if ($this->session->userdata('KodeCabang')=='00004/04'){
	            						...
	            						?>
	            						<!-- <?php
	            					if ($this->session->userdata('KodeCabang')=='00004/05'){
	            						?>
	            						<th style="font-size:14px;"></th>
                                        <th style="font-size:14px;"></th>
                                        <th style="font-size:14px;"></th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
    	...
    	var nama_supplier = "-";
    	$.ajax({
            url: '<?php echo base_url(); ?>J-Order/Order/ajax_principle',
            type: "GET",
            dataType: "json",
		...
		var tbld=$('#tabled_order').DataTable({
		    ...
		    //             }
				 ...
				 "ajax": {
		            ...
		            "url": "<?php echo base_url(); ?>J-Order/Order/ajax_order/"+kode_supplier,
		            "dataSrc": ""
		        },
		        "columns": [
		            { "data": "NoStruk" },
				...
				if ($this->session->userdata('KodeCabang')=='00001/01'){
					...
					?>
					{ "data": "RppSrgMTKtn", render: $.fn.dataTable.render.number(',', '.', 0, ''),"sClass": "numberright" },
					{ "data": "RppSrgGroKtn", render: $.fn.dataTable.render.number(',', '.', 0, ''),"sClass": "numberright" },
					{ "data": "RppSrgSnackKtn", render: $.fn.dataTable.render.number(',', '.', 0, ''),"sClass": "numberright" },
					{ "data": "RppKtn", render: $.fn.dataTable.render.number(',', '.', 0, ''),"sClass": "numberright" },
					{ "data": "RppSrgMTRp", render: $.fn.dataTable.render.number(',', '.', 0, ''),"sClass": "numberright" },
					{ "data": "RppSrgGroRp", render: $.fn.dataTable.render.number(',', '.', 0, ''),"sClass": "numberright" },
					{ "data": "RppSrgSnackRp", render: $.fn.dataTable.render.number(',', '.', 0, ''),"sClass": "numberright" },
					{ "data": "RppRp", render: $.fn.dataTable.render.number(',', '.', 0, ''),"sClass": "numberright" },
					<?php
				}
					?>
				...
				if ($this->session->userdata('KodeCabang')=='00001/01'){
					...
					?>
					{ "data": "SpSrgMTKtn", render: $.fn.dataTable.render.number(',', '.', 0, ''),"sClass": "numberright" },
					{ "data": "SpSrgGroKtn", render: $.fn.dataTable.render.number(',', '.', 0, ''),"sClass": "numberright" },
					{ "data": "SpSrgSnackKtn", render: $.fn.dataTable.render.number(',', '.', 0, ''),"sClass": "numberright" },
					{ "data": "SpKtn", render: $.fn.dataTable.render.number(',', '.', 0, ''),"sClass": "numberright bluecolor textbold" },
					{ "data": "SpAdjKtn", render: $.fn.dataTable.render.number(',', '.', 0, ''),"sClass": "numberright bluecolor textbold" },
					{ "data": "SpSrgMTRp", render: $.fn.dataTable.render.number(',', '.', 0, ''),"sClass": "numberright" },
					{ "data": "SpSrgGroRp", render: $.fn.dataTable.render.number(',', '.', 0, ''),"sClass": "numberright" },
					{ "data": "SpSrgSnackRp", render: $.fn.dataTable.render.number(',', '.', 0, ''),"sClass": "numberright" },
					<?php
				}
					?>
