						    ...
						    <div class="modal-dialog">
						      ...
						      <div class="modal-content">
						        ...
						        <div class="modal-body">
						          	<form role="form" method="post" id="FP" action="<?php echo base_url('J-Order/SalesPlan/add_discontinued'); ?>">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('select[name="Group"]').on('change', function() {
            ...
            if(kodeGroup1) {
        		$.ajax({
                    url: '<?php echo base_url(); ?>J-Order/SalesPlan/ajax_produk/'+kodesup1+'/'+kodeGroup1,
                    type: "GET",
                    dataType: "json",
                    success:function(data) {
                    	// alert(KodeDepo);
