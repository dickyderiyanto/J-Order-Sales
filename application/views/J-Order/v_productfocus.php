						        ...
						        <thead>
						         ...
						         <?php 
						         	...
						         	echo '<tr>          
							            ...
							            <td>
											<a onclick=\'delete_salesplan("1","'.$data_produk->Kode.'")\' href="javascript:;" class="btn btn-danger"><i class="fa fa-trash-o"></i> Hapus</a>
										</td>
									</tr> ';                         
						    ...
						    <div class="modal-dialog  modal-lg">
						      ...
						      <div class="modal-content">
						        ...
						        <div class="modal-body">
						          	<form role="form" method="post" id="FP" action="<?php echo base_url('J-Order/SalesPlan/add_focus'); ?>">
