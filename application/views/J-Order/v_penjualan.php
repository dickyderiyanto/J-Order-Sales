						...
						<div class="canvas-wrapper">
					        ...
					        <thead>
					         ...
					         <?php 
					         	...
					         	echo '<tr>                           
						            <td>'.$data_penjualan->KodeSM.' - '.$data_penjualan->SM.'</td>
						            <td>'.$data_penjualan->Supplier.'</td>            
						            <td>'.$data_penjualan->KodeProduk.' - '.$data_penjualan->NamaProduk.'</td>            
									<td>'.$data_penjualan->Crt.'</td>            
									<td>'.$data_penjualan->Pcs.'</td> 
									<td>'.$data_penjualan->Nilai.'</td>        
						            <td>
						            	<a class="" href="#">
